...
const Kelas2BahasaBab4 = {
  async render() {
    ...
    const objectTarget = materi.filter((m) => m.id === "bhsindo2b401");
    const pages = objectTarget.filter((m) => m.id === "bhsindo2b401")[0];
    ...
    <div class="container">
      <div class="inner-container-bab">
        ...
        <div class="box-btn-move-pagebab">
          <a class="btn-move-pagebab" href="#/kelas2bahasabab3">Sebelumnya</a>
          <a class="btn-move-pagebab" href="#/kelasduabahasa">Selanjutnya</a>
        </div>
      </div>
    </div>
    </main>
...
export default Kelas2BahasaBab4;