...
const Kelas2BahasaBab3 = {
  async render() {
    ...
    const objectTarget = materi.filter((m) => m.id === "bhsindo2b301");
    const pages = objectTarget.filter((m) => m.id === "bhsindo2b301")[0];
    ...
    <div class="container">
      <div class="inner-container-bab">
        ...
        <div class="box-btn-move-pagebab">
          <a class="btn-move-pagebab" href="#/kelas2bahasabab2">Sebelumnya</a>
          <a class="btn-move-pagebab" href="#/kelas2bahasabab4">Selanjutnya</a>
        </div>
      </div>
    </div>
    </main>
...
export default Kelas2BahasaBab3;