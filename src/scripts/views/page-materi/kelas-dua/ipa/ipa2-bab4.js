...
const Kelas2IpaBab4 = {
  async render() {
    ...
    const objectTarget = materi.filter((m) => m.id === "ipa2b401");
    console.log(objectTarget);
    const pages = objectTarget.filter((m) => m.id === "ipa2b401")[0];
    ...
    <div class="container">
      <div class="inner-container-bab">
        ...
        <div class="box-btn-move-pagebab">
          <a class="btn-move-pagebab" href="#/kelas2ipabab3">Sebelumnya</a>
          <a class="btn-move-pagebab" href="#/kelasduaipa">Selanjutnya</a>
        </div>
      </div>
    </div>
    </main>
