...
const Kelas3BahasaBab2 = {
  async render() {
    ...
    const objectTarget = materi.filter((m) => m.id === "bhsindo3b201");
    const pages = objectTarget.filter((m) => m.id === "bhsindo3b201")[0];
    ...
    <div class="container">
      <div class="inner-container-bab">
        ...
        <div class="box-btn-move-pagebab">
          <a class="btn-move-pagebab" href="#/kelas3bahasabab1">Sebelumnya</a>
          <a class="btn-move-pagebab" href="#/kelas3bahasabab3">Selanjutnya</a>
        </div>
      </div>
    </div>
    </main>
...
export default Kelas3BahasaBab2;