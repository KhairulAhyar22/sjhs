...
const Kelas3BahasaBab4 = {
  async render() {
    ...
    const objectTarget = materi.filter((m) => m.id === "bhsindo3b401");
    const pages = objectTarget.filter((m) => m.id === "bhsindo3b401")[0];
    ...
    <div class="container">
      <div class="inner-container-bab">
        ...
        <div class="box-btn-move-pagebab">
          <a class="btn-move-pagebab" href="#/kelas3bahasabab3">Sebelumnya</a>
          <a class="btn-move-pagebab" href="#/kelastigabahasa">Selanjutnya</a>
        </div>
      </div>
    </div>
    </main>
...
export default Kelas3BahasaBab4;